...
<div class="x-body">
    ...
    <xblock>
        <button id="addStudnetBtn" class="layui-btn layui-btn"> <i class="layui-icon">&#xe654;</i>添加 </button>
        <button id="download" class="layui-btn layui-btn-normal" > <i class="layui-icon">&#xe601;</i><a href="http://localhost:8080/template/student.xls" style="color: white" download="学生信息.xls">下载模板</a></button>
