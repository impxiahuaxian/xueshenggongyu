...
<div class="x-body">
    ...
    <xblock>
        ...
        <button id="download" class="layui-btn layui-btn-normal" > <i class="layui-icon">&#xe601;</i><a href="http://localhost:8080/template/dormrepair.xls" style="color: white" download="宿舍报修.xls">下载模板</a></button>
